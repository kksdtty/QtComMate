...
class Ui_serialForm(object):
    ...
    def retranslateUi(self, serialForm):
        ...
        self.serialSendLineFeedComboBox.setItemText(1, _translate("serialForm", "CRLF"))
        self.serialSendLineFeedComboBox.setItemText(2, _translate("serialForm", "CR"))
        self.serialSendLineFeedComboBox.setItemText(3, _translate("serialForm", "LF"))
